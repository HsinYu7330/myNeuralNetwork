...
from keras.layers import Input, Dropout, Embedding, Dense, GRU, GlobalAveragePooling1D
...
latent_vec = GRU(64, return_sequences=True)(embeddings)
latent_vec = Dropout(0.2)(latent_vec)
latent_vec = GRU(32, return_sequences=False)(latent_vec)
latent_vec = Dropout(0.2)(latent_vec)
