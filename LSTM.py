...
from keras.layers import Input, Dropout, Embedding, Dense, LSTM, GlobalAveragePooling1D
...
latent_vec = LSTM(64, return_sequences=True)(embeddings)
latent_vec = Dropout(0.2)(latent_vec)
latent_vec = LSTM(32, return_sequences=False)(latent_vec)
latent_vec = Dropout(0.2)(latent_vec)
